...
I'm currently working on forecasting with dynamic panel data models. In particular, I develop a constrained Bayesian grouped estimator that leverages prior information on the latent constant group structure to assist forecasting. It is an exciting area that involves panel data model estimation, semisupervised machine learning and network models.
